<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GLSCarrier.aspx.cs" Inherits="GLSFinal.Carrier.GLSCarrier" %>
...
<body>
   ...
   <div class="clsCarrierMain">
    ...
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="698px" 
            Height="595px">
            <LocalReport ReportPath="Carrier\Report1.rdlc">
                <DataSources>
